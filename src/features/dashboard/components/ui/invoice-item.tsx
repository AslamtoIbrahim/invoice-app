...
import { calcTotal, fixDate, fixPrice } from "../../lib/utils/utils";
...
function InvoiceItem({ className, invoice, ...props }: InvoiceItemProps) {
    ...
    return <div onClick={handleClick} className={cn('bg-popover p-4 rounded-lg cursor-pointer hover:shadow-md transition-shadow ',
        ...
        <p className="font-light col-span-1 row-span-1 text-end md:text-center truncate w-30">{invoice.billTo.name}</p>
